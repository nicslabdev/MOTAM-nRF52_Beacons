 ...
 *
 *  This is the starting point of BT5 secure frame beacon. This beacon generates a secure
 *  signature and send a frame that includes data and a secure digital signature (ECDSA
...
// [MOTAM] Advertising init function: configures advertising parameters for BLE 4
static void motam_advertising_init(void)
{
    ...
    m_adv_params.properties.type = BLE_GAP_ADV_TYPE_NONCONNECTABLE_NONSCANNABLE_UNDIRECTED;	// [MOTAM] This is for BLE 4 codification (BLE_GAP_PHY_1MBPS)
